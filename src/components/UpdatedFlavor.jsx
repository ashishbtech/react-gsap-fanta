...
export default function UpdatedFlavor({ twoRef }) {
  return (
    <div ref={twoRef} className="flex w-full h-[100vh] bg-[#4d231c]">
      <div className="flex items-start justify-center flex-col gap-[5vh] w-1/2 h-full">
        <svg className="mt-[50vh] w-[90%]" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
